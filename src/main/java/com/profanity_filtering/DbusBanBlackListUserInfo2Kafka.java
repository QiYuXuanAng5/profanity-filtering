package com.profanity_filtering;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONObject;

import com.github.houbb.sensitive.word.core.SensitiveWordHelper;
import com.profanity_filtering.func.FilterBloomDeduplicatorFunc;
import com.profanity_filtering.func.MapCheckRedisSensitiveWordsFunc;
import com.profanity_filtering.util.ConfigUtils;
import com.profanity_filtering.util.EnvironmentSettingUtils;
import com.profanity_filtering.util.KafkaUtils;
 ...
 * @Test DataStreamSource<String> kafkaCdcDbSource = env.socketTextStream("127.0.0.1", 9999);
 */
